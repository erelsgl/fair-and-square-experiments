/** 
 * 
 * Finding a maximum-weight matching (aka "maxsum matching") in a bipartite graph.
 * Uses the Hungarian algorithm for solving the "assignment problem".
 * 
 * Most of the code is due to Mike's blog: Two-Four-One:
 * http://twofourone.blogspot.co.il/2009/01/hungarian-algorithm-in-javascript.html
 * 
 * Translated from Javascript to Node.js by Erel Segal-Halevi.
 * 
 * References:
...
module.exports = function maxsum(agents) {
    console.log(213);
	return agents;
}
...
/**
 * A simple class that represents coordinates in a matrix.
 */
function MatrixCoords() {
    this.row = -1;
    this.col = -1;
}
